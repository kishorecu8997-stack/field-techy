...
export const BUSINESS_TYPES: BusinessType[] = [
  ...
  },
  {
    id: 'service',
    name: 'Service',
    description: 'Businesses offering professional or personal services (e.g., consulting, cleaning, legal, etc.).'
  },
  {
    id: 'maintenance',
    name: 'Maintenance',
    description: 'Companies providing repair, upkeep, or servicing of equipment, facilities, or systems.'
  }
];
...
export const INDUSTRIES: Industry[] = [
  {
    id: 'technology',
    name: 'Technology',
    description: 'Software development, IT services, hardware, and digital innovation.'
  },
  {
    id: 'healthcare',
    name: 'Healthcare',
  ...
  },
  {
    id: 'education',
    name: 'Education',
    description: 'Schools, universities, e-learning platforms, and training providers.'
  },
  {
    id: 'retail',
    name: 'Retail',
    description: 'Stores and e-commerce businesses selling directly to consumers.'
  },
  {
    id: 'manufacturing',
    name: 'Manufacturing',
  ...
  },
  {
    id: 'construction',
    name: 'Construction',
    description: 'Building infrastructure, residential, and commercial properties.'
  },
  {
    id: 'transportation',
  ...
  },
  {
    ...
    description: 'Businesses offering personal or professional services not covered elsewhere.'
  },
  {
    id: 'maintenance',

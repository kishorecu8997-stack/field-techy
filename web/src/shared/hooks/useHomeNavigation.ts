...
export const useHomeNavigation = () => {
  ...
  return {
    ...
    goToJobDetails: (jobId: string) =>
      navigate(`${absoluteUrls.engineer.home.my_jobs}/${jobId}`),
    goToFAQ: () => navigate(absoluteUrls.engineer.home.faq),
    goToTerms: () => navigate(absoluteUrls.engineer.home.terms_and_conditions),
    goToPrivacyPolicy: () =>
      navigate(absoluteUrls.engineer.home.privacy_policy),
    goToDashboard: () => navigate(absoluteUrls.engineer.home.dashboard),
  };
};

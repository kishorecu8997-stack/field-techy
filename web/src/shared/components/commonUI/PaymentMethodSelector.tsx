...
const PaymentMethodSelector: React.FC<PaymentMethodSelectorProps> = ({
  ...
  return (
    <div className="space-y-3">
      ...
      <div
        onClick={onAddNew}
        className="border-2 border-dashed rounded-lg p-4 text-center cursor-pointer transition-colors border-gray-300 hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-800"
      >
        <button
          type="button"
          className="text-sm font-medium flex items-center justify-center w-full text-emerald-700 dark:text-emerald-400"
        >
          <svg

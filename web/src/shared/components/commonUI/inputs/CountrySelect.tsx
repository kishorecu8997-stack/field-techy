    ...
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={`flex items-center w-20 gap-1 px-3 py-3 border-r border-gray-300 dark:border-gray-600 cursor-pointer ${
          disabled
            ? "bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 cursor-not-allowed rounded-md"
            : "bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100  rounded-md"
        }`}

            ...
            <div className="flex gap-4 justify-center">
              {Array.from({ length }).map((_, idx) => (
                <input
                  ...
                  onPaste={handlePaste}
                  className="w-13 h-13 text-center text-xl rounded-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary focus:border-primary outline-none"

...
const Divider = () => <div className="h-6 w-px bg-gray-200 flex-shrink-0" />;
...
export const JobSearchBar = ({
  ...
  return (
    <div
      className={`relative w-full ${showDropdowns ? "max-w-4xl" : "max-w-lg"} mx-auto`}
    >
      <FormContainer
        ...
        >
          <div className="relative flex-1 min-w-[150px] flex-grow flex items-center px-5 py-2">
            <input
              ...
              placeholder={
                isEngineerRoute ? "Search Jobs.." : "Search Engineers.."
              }

...
const VerificationCard = ({ type, contact, isVerified, onVerifySuccess }: VerificationCardProps) => {
    ...
    const { isPending: isVerifyingEmail, mutate: verifyEmail } = useVerifyEmailOTP({
        onSuccess: () => {
    ...
    const { isPending: isVerifyingPhone, mutate: verifyPhone } = useVerifyPhoneOTP({
        onSuccess: () => {
    ...
    const isPending = isSendingEmail || isSendingPhone || isVerifyingEmail || isVerifyingPhone;
                            ...
                            <>
                                ...
                                <div className="flex justify-between items-center mb-4 text-sm text-gray-500 dark:text-gray-400 p-5 px-1">
                                    ...
                                    <button
                                        ...
                                        className={`text-green-600 dark:text-green-400 font-medium ${(timeLeft > 0 || isPending) ? "opacity-50 cursor-not-allowed" : ""
                                            }`}
                                    >
                                        Resend
                                    </button>
...
const ContactVerification = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen w-full bg-gray-50 dark:bg-gray-900">
            ...
            <div className="flex-1 overflow-y-auto px-4 py-8 max-w-4xl mx-auto w-full flex flex-col md:flex-row gap-6 items-start justify-center">

...
type ApiJobStatus = NonNullable<Parameters<typeof useClientGetJobs>[0]>["jobStatus"];
...
const MyJobsClient: React.FC = () => {
  ...
  const { data: jobsData, isLoading } = useClientGetJobs({ jobStatus: apiJobStatus, enabled: true });

                  ...
                  {(item.attachmentUrl || item.proposalAttachmentUrl) && (
                    <div className="mt-2">
                      ...
                      >
                        ...
                        {(item.logType === "SUBMISSION" || item.title?.includes("Proposal")) ? "View Attachment" : (item.attachmentName || getAttachmentFileName({ url: item.attachmentUrl || item.proposalAttachmentUrl || undefined }) || "View Attachment")}
                      </a>
                    </div>
                  )}

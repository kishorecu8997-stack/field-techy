...
const JobCard: React.FC<{
  ...
  userTools = [],
    ...
    const STATUS_LABEL_MAP: Record<keyof typeof STATUS_VARIANT_MAP, string> = {
      new: "New",
      offer: "Offer",
      applied: "Applied",
    ...
    // Use the dedicated label map; fall back to raw job.status only for unknown statuses.
    const statusLabel = statusKey ? STATUS_LABEL_MAP[statusKey] : job.status;

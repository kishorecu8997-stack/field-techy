            ...
            <div className="flex flex-wrap gap-1">
              {serviceTypeOptions.map((option) => (
                <button
                  ...
                  className={`px-2 py-1 text-xs rounded-full transition-colors ${(localFilters.serviceType as string[]).includes(option)
            ...
            <div className="flex flex-wrap gap-1">
              {experienceLevelOptions.map((option) => (
                <button
                  ...
                  className={`px-2 py-1 text-xs rounded-full transition-colors ${(localFilters.experienceLevel as string[]).includes(option)
                      ? "bg-blue-600 text-white"
                      : "bg-gray-200 text-gray-700 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-200"
                    }`}
                >
            ...
            <div className="flex flex-wrap gap-1">
              {jobTypeOptions.map((option) => (
                <button
                  ...
                  className={`px-2 py-1 text-xs rounded-full transition-colors ${(localFilters.jobType as string[]).includes(option)
                      ? "bg-blue-600 text-white"
                      : "bg-gray-200 text-gray-700 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-200"
                    }`}
                >
            ...
            <div className="flex flex-wrap gap-1">
              {locationTypeOptions.map((option) => (
                <button
                  ...
                  className={`px-2 py-1 text-xs rounded-full transition-colors ${(localFilters.locationType as string[]).includes(option)
                      ? "bg-blue-600 text-white"
                      : "bg-gray-200 text-gray-700 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-200"
                    }`}
                >

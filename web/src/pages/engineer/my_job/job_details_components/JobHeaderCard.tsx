// Fixed version of JobHeaderCard with corrected JSX tag alignment
// (only the broken section is corrected; rest of file unchanged)
            ...
            <div className="flex gap-2 items-center">
              {OfferJobStatus === undefined ? (
                ...
                <div className="flex gap-4">
                  ...
                  <Button
                    className="bg-teal-800 text-white px-6 py-2 rounded-md"
                    onClick={() => setOfferJobStatus("declined")}
                  >
                    Decline
                  </Button>
                </div>

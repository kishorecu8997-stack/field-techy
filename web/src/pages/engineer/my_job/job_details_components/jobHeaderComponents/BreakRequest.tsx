...
import type { JobLike } from "../../types.d.ts";
  ...
  return (
    <div className="flex flex-col p-6 text-gray-900 dark:text-gray-100">
      <div className="relative mb-4">
        <h2 className="text-xl text-black dark:text-white font-bold text-center">
          Break Request
        </h2>
        <div
          className="absolute right-0 top-0 cursor-pointer text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100"
          onClick={onClose}
        >

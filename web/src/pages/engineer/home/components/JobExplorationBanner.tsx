    ...
    <div className="relative overflow-hidden rounded-2xl bg-emerald-900 px-4 md:px-6 text-white">
      <div className="flex flex-col items-center gap-4 md:flex-row md:items-end md:justify-between">
        <div className="max-w-lg space-y-2 py-10">
          ...
          <button className="mt-2 rounded-lg bg-emerald-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2">
            Explore Jobs
          </button>
        </div>

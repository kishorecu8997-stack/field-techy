 ...
 * CompletedJob
 *
 * Displays a searchable table of completed jobs for an engineer,
 * and a small analytics chart that summarizes completed jobs over a selectable
 * time window.
 *
 * Features:
 ...
 * - Chart summary using `GeneralChart` with configurable series and tooltip
 *
 * Notes:
 * - This component uses dummy data from `@/dummy_data/admin/manageEngineer`.
 * - It currently accepts no props; to make it reusable, consider accepting
 *   `data`, `onToggleStatus`, and chart configuration via props.
 *
 * @component
 * @returns {JSX.Element} The completed jobs table and chart section
 */

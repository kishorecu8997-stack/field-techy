 ...
 * @description This component displays jobs to which an engineer has been invited. It features a
 ...
 *
 * @returns {React.FC} The rendered component for managing invited jobs.
 */

 ...
 * HoldJob Component
 *
 * Displays jobs currently on hold for an engineer.
 * Includes searchable table + analytics chart.
 */
      ...
      renderCell: (row) => (
        <div
          className={`px-3 py-1 rounded-full text-sm font-medium ${
            row.jobStatus === "On Hold" ? "bg-yellow-100 text-yellow-700" : "bg-green-100 text-green-700"
          }`}
        >
          {row.jobStatus}
        </div>
    ...
    <div className="w-full h-full flex flex-col p-3 gap-3">
      ...
      <div className="w-1/2">
        <div className="flex justify-between items-center mt-2 md:mb-2 gap-4">
          <p className="font-bold">Total Jobs On Hold</p>
          <SelectMenu

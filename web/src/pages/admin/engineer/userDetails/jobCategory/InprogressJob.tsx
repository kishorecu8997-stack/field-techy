...
/**
 * InprogressJob Component
 *
 * Displays:
 * - In-progress jobs table for a selected engineer
 ...
 *
 * Notes:
 * - Fetches data from API with `statusGroup: "inProgress"`
 * - All formatting done in `renderCell`
 *
 * @component
 */
    ...
    <div className="w-full h-full flex flex-col p-3 gap-3">
        ...
        <CustomTable<EngineerAssignment>
          ...
          error={
            !hasValidUserId
              ...
              : error
                ? "An error occurred while fetching in-progress jobs."
                : null
          }
      ...
      <div className="w-1/2">
        <div className="flex justify-between items-center mt-2 md:mb-2 gap-4">
          <p className="font-bold">Total Jobs In Progress</p>
          <SelectMenu

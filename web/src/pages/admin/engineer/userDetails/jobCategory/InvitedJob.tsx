...
/**
 * InvitedJob Component
 *
 * Displays:
 * - Jobs an engineer has been invited to
 ...
 *
 * Notes:
 * - Fetches data from API with `statusGroup: "invited"`
 * - All formatting done in `renderCell`
 *
 * @component
 */
const InvitedJob: React.FC = () => {
    ...
    <div className="w-full h-full flex flex-col p-3 gap-3">
      ...
      <div className="w-1/2">
        <div className="flex justify-between items-center mt-2 md:mb-2 gap-4">
          <p className="font-bold">Total Jobs Invited</p>
          <SelectMenu

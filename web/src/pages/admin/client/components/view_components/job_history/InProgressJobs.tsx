...
import type { InProgressJobsProps } from "../../../types";
...
const InProgressJobs: React.FC = () => {
  ...
  //Delete confirmation
  const handleDeleteJob = async (job: InProgressJobsProps) => {
    await showPopup({
      title: "Delete Job",
  ...
  const columns: Column<InProgressJobsProps>[] = [
    ...
    { key: "createdDate", label: "Created Date" },
    {
      key: "status",
      label: "Status",
      renderCell: (row: InProgressJobsProps) => {
    ...
    <div className="w-full h-full flex flex-col p-3 gap-3 ">
      <div className="p-3 h-full w-full flex flex-1 overflow-y-auto flex-col bg-neutral-100 dark:bg-neutral-800 rounded-md gap-2">
        ...
        <div className="h-full flex-1 overflow-y-auto ">
          <CustomTable<InProgressJobsProps>
            columns={columns}
            data={postedJobsData}
            initialPageSize={10}
          />

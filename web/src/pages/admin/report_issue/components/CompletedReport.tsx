 ...
 * @description A historical view of all resolved issues. Includes functionality
 * to audit historical data and verify commission values or resolution times.
 */
export default function CompletedReport() {
  ...
  const solvedConfirmation = async (data: AdminReportIssue) => {
    await showPopup({
      ...
      body: "Are you sure the problem is solved?",
      actionButtons: [
        {
          label: "Cancel",
          value: null,

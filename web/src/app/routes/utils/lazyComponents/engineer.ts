...
export const EngineerDocuments = React.lazy(
  () =>
    import("@/pages/engineer/auth/components/profile_setup/updated_profile_setup/BasicDocuments"),
);
export const EngineerContactVerification = React.lazy(
  () =>
    import("@/pages/engineer/auth/components/profile_setup/updated_profile_setup/ContactVerification"),
);
...
export const EngineerNotificationListPage = React.lazy(
  () =>
    import("@/pages/engineer/account_settings/notification/NotificationListPage"),
);

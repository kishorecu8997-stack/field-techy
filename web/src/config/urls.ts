...
export const urls = {
  ...
  admin: {
    ...
    home: {
      ...
      edit_rate_card: "rate-card/edit/:id",
      view_rate_card: "rate-card/view/:id",
...
export const absoluteUrls = {
  ...
  admin: {
    ...
    home: {
      ...
      edit_rate_card: `${BASE.ADMIN}/rate-card/edit/:id`,
      view_rate_card: `${BASE.ADMIN}/rate-card/view/:id`,

...
export const urls = {
  ...
  admin: {
    ...
    home: {
      ...
      manage_tools: "tools",
      manage_tools_add: "tools/add",
      manage_tools_edit: "tools/edit",
      manage_skills: "skills",
      manage_skills_add: "skills/add",
      manage_skills_edit: "skills/edit",
      ...
      edit_rate_card: "rate-card/edit/:serviceCategoryId/:countryId",
      view_rate_card: "rate-card/view/:serviceCategoryId/:countryId",
...
export const absoluteUrls = {
  ...
  engineer: {
    ...
    home: {
      ...
      recommended_jobs: `${BASE.ENGINEER}/recommended-jobs`,
      featured_jobs: `${BASE.ENGINEER}/featured-jobs`,
  ...
  admin: {
    ...
    home: {
      ...
      manage_tools: `${BASE.ADMIN}/tools`,
      manage_tools_add: `${BASE.ADMIN}/tools/add`,
      manage_tools_edit: `${BASE.ADMIN}/tools/edit`,
      manage_skills: `${BASE.ADMIN}/skills`,
      manage_skills_add: `${BASE.ADMIN}/skills/add`,
      manage_skills_edit: `${BASE.ADMIN}/skills/edit`,
      ...
      edit_rate_card: `${BASE.ADMIN}/rate-card/edit/:serviceCategoryId/:countryId`,
      view_rate_card: `${BASE.ADMIN}/rate-card/view/:serviceCategoryId/:countryId`,

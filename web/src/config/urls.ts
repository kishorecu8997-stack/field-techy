...
export const urls = {
  ...
  client: {
    ...
    home: {
      ...
      terms_and_conditions: "terms-and-conditions",
      privacy_policy: "privacy-policy",
      explore_engineers_details: "explore-engineers/details",
  ...
  admin: {
    ...
    home: {
      ...
      roleList: "roles",
      corporateClientAdd: "manage-client/add",
      homeClientAdd: "manage-client/add",
      corporateClientEdit: "manage-client/edit",
      homeClientEdit: "manage-client/edit",
      corporateClientView: "manage-client/view",
      homeClientView: "manage-client/view",
...
export const absoluteUrls = {
  ...
  client: {
    ...
    home: {
      ...
      explore_engineers_details: `${BASE.CLIENT}/explore-engineers/details`,
  ...
  admin: {
    ...
    home: {
      ...
      corporateClientAdd: `${BASE.ADMIN}/manage-client/add`,
      homeClientAdd: `${BASE.ADMIN}/manage-client/add`,
      corporateClientEdit: `${BASE.ADMIN}/manage-client/edit`,
